  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full">
      ...
      <div className="relative w-full h-[450px] flex items-center justify-center">
        ...
        <div 
          className="absolute bottom-[200px] left-1/2 -translate-x-1/2 w-[700px] h-6 bg-scale-arm rounded-full shadow-lg transition-transform duration-500 ease-in-out z-10"
        ...
        <div className="absolute bottom-0 left-8 w-80 h-64 flex flex-col items-center transition-transform duration-500 ease-in-out z-0"
          ...
          <div className="relative w-full h-48 bg-gradient-to-b from-scale-bowl to-scale-arm rounded-b-[50%] shadow-xl border-4 border-scale-arm overflow-hidden">
            <div className="absolute inset-2 bg-white/20 rounded-b-[45%]" />
            {/* Left bowl content area - larger space */}
            <div className="absolute inset-0 p-3 flex flex-wrap gap-2 items-end justify-center content-end pb-4 overflow-auto">
